...
export class Migration20240501133551 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "bridge" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "texture" int not null, "scale" real not null, "pivot_position" jsonb not null, "string_count" smallint not null, "string_spawn_point" jsonb not null);');
    ...
    this.addSql('create table "knob" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null);');

    this.addSql('create table "jack" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "is_side" boolean not null);');

    this.addSql('create table "guitar_body_texture" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "scale" real not null default 1, "front_hole_mask_id" int null, "front_mask_id" int null, "back_mask_id" int null, "front_shadow_texture_id" int null, "back_shadow_texture_id" int null, "front_specular_texture_id" int null, "back_specular_texture_id" int null);');
    ...
    this.addSql('create table "guitar_model" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "bolt_on_body_id" int null, "neck_through_body_id" int null, "set_in_body_id" int null);');
    ...
    this.addSql('create table "headstock" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "model_id" int null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "string_count" smallint not null, "pegs_spawn_point" jsonb not null);');

    this.addSql('create table "nut" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "string_count" smallint not null, "string_spawn_point" jsonb not null);');

    this.addSql('create table "peg" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "peg_cap_texture_id" int null, "peg_back_texture_id" int null, "peg_back_pivot_position" jsonb null, "scale" real not null, "pivot_position" jsonb not null);');

    this.addSql('create table "pickguard" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "model_id" int not null);');

    this.addSql('create table "pickup" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "type" text check ("type" in (\'single\', \'humbucker\', \'p90\')) not null);');

    this.addSql('create table "switch" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null);');
    ...
    this.addSql('alter table "guitar_body_texture" add constraint "guitar_body_texture_front_mask_id_foreign" foreign key ("front_mask_id") references "media" ("id") on update cascade on delete set null;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "guitar_body_texture" drop constraint "guitar_body_texture_front_mask_id_foreign";');
