...
export class Migration20240528133509 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "guitar_model" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "thumbnail_id" int null, "fingerboard_spawn_point" jsonb null, "bridge_spawn_point" jsonb null, "allow_single_coil_pickup" boolean null, "pickup_spawn_point" jsonb null, "knob_spawn_point" jsonb null, "switch_spawn_point" jsonb null, "top_jack_spawn_point" jsonb null, "side_jack_spawn_point" jsonb null);');
    this.addSql('alter table "guitar_model" add constraint "guitar_model_name_unique" unique ("name");');

    this.addSql('create table "headstock" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "thumbnail_id" int null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "model_id" int null, "string_count" smallint not null, "pegs_spawn_point" jsonb not null);');
    this.addSql('alter table "headstock" add constraint "headstock_name_unique" unique ("name");');

    this.addSql('create table "guitar_body_texture" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "scale" real not null, "front_hole_mask_id" int null, "mask_id" int null, "back_mask_id" int null, "front_shadow_texture_id" int null, "back_shadow_texture_id" int null, "front_specular_texture_id" int null, "back_specular_texture_id" int null);');

    this.addSql('create table "guitar_body" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "mask_id" int null, "mask_scale" real null);');

    this.addSql('create table "guitar_model_body_pivot" ("texture" serial primary key, "model_id" int not null, "body_id" int null, "type" text check ("type" in (\'boltOnBody\', \'neckThroughBody\', \'setInBody\')) not null);');
    ...
    this.addSql('create table "guitar_body_texture_pivot" ("texture" serial primary key, "body_id" int not null, "texture_id" int null, "type" text check ("type" in (\'carvedTopTexture\', \'tummyCutTexture\', \'forearmCutTexture\', \'flatTopBackTexture\', \'carvedTopBackTexture\', \'forearmTummyCutTexture\', \'carvedTopTummyCutTexture\')) not null);');
    ...
    this.addSql('create table "pickguard" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "model_id" int not null);');

    this.addSql('create table "pickup" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "thumbnail_id" int null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "type" text check ("type" in (\'single\', \'humbucker\', \'p90\')) not null);');
