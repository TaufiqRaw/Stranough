...
export class Migration20240604185431 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "knob" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "thumbnail_id" int null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null);');
    ...
    this.addSql('create table "jack" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "thumbnail_id" int null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "is_side" boolean not null);');
    ...
    this.addSql('create table "headstock" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "thumbnail_id" int null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "string_count" smallint not null, "pegs_spawn_point" jsonb not null, "front_shadow_texture_id" int null, "back_shadow_texture_id" int null);');
    ...
    this.addSql('create table "guitar_model" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "thumbnail_id" int null, "fingerboard_spawn_point" jsonb null, "bridge_spawn_point" jsonb null, "allow_single_coil_pickup" boolean null, "price" int not null, "pickup_spawn_point" jsonb null, "is_electric" boolean null, "knob_spawn_point" jsonb null, "switch_spawn_point" jsonb null, "top_jack_spawn_point" jsonb null, "side_jack_spawn_point" jsonb null);');
    this.addSql('alter table "guitar_model" add constraint "guitar_model_name_unique" unique ("name");');
    this.addSql('CREATE INDEX "guitar_model_hnsw_l2_idx" ON "guitar_model" USING hnsw (embedding vector_l2_ops);');

    this.addSql('create table "guitar_body_texture" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "scale" real not null, "price" int not null default 0, "front_hole_mask_id" int null, "mask_id" int null, "back_mask_id" int null, "front_shadow_texture_id" int null, "back_shadow_texture_id" int null, "front_specular_texture_id" int null, "back_specular_texture_id" int null, "burst_top_id" int null, "burst_back_id" int null);');

    this.addSql('create table "guitar_body" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "mask_id" int null, "mask_scale" real null, "burst_top_id" int null, "burst_back_id" int null, "price" int not null default 0);');

    this.addSql('create table "guitar_model_body_pivot" ("id" serial primary key, "model_id" int not null, "body_id" int null, "type" text check ("type" in (\'boltOnBody\', \'neckThroughBody\', \'setInBody\')) not null);');
    this.addSql('alter table "guitar_model_body_pivot" add constraint "guitar_model_body_pivot_model_id_body_id_type_unique" unique ("model_id", "body_id", "type");');

    this.addSql('create table "guitar_body_texture_pivot" ("id" serial primary key, "body_id" int not null, "texture_id" int null, "type" text check ("type" in (\'carvedTopTexture\', \'tummyCutTexture\', \'forearmCutTexture\', \'flatTopBackTexture\', \'carvedTopBackTexture\', \'forearmTummyCutTexture\', \'carvedTopTummyCutTexture\')) not null);');
    this.addSql('alter table "guitar_body_texture_pivot" add constraint "guitar_body_texture_pivot_body_id_texture_id_type_unique" unique ("body_id", "texture_id", "type");');
    ...
    this.addSql('create table "peg" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "thumbnail_id" int null, "price" int not null, "peg_cap_texture_id" int null, "peg_back_texture_id" int null, "peg_back_pivot_position" jsonb not null, "scale" real not null, "pivot_position" jsonb not null);');
    ...
    this.addSql('create table "pickguard" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "model_id" int not null);');
    ...
    this.addSql('create table "pickup" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "thumbnail_id" int null, "price" int not null, "texture_id" int null, "scale" real not null, "pivot_position" jsonb not null, "type" text check ("type" in (\'single\', \'humbucker\', \'p90\')) not null, "string_count" int not null);');
    ...
    this.addSql('create table "wood" ("id" serial primary key, "created_at" timestamptz not null, "updated_at" timestamptz not null, "name" varchar(255) not null, "description" varchar(1000) not null, "embedding" vector(1536) not null, "price" int not null, "texture_id" int null);');
    ...
    this.addSql('alter table "guitar_body_texture" add constraint "guitar_body_texture_burst_top_id_foreign" foreign key ("burst_top_id") references "media" ("id") on update cascade on delete set null;');
    this.addSql('alter table "guitar_body_texture" add constraint "guitar_body_texture_burst_back_id_foreign" foreign key ("burst_back_id") references "media" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "guitar_model_body_pivot" add constraint "guitar_model_body_pivot_model_id_foreign" foreign key ("model_id") references "guitar_model" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "guitar_model_body_pivot" add constraint "guitar_model_body_pivot_body_id_foreign" foreign key ("body_id") references "guitar_body" ("id") on update cascade on delete set null;');

    this.addSql('alter table "guitar_body_texture_pivot" add constraint "guitar_body_texture_pivot_body_id_foreign" foreign key ("body_id") references "guitar_body" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "guitar_body_texture_pivot" add constraint "guitar_body_texture_pivot_texture_id_foreign" foreign key ("texture_id") references "guitar_body_texture" ("id") on update cascade on delete set null;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "guitar_body_texture" drop constraint "guitar_body_texture_burst_top_id_foreign";');

    this.addSql('alter table "guitar_body_texture" drop constraint "guitar_body_texture_burst_back_id_foreign";');
    ...
    this.addSql('alter table "guitar_model_body_pivot" drop constraint "guitar_model_body_pivot_model_id_foreign";');

    this.addSql('alter table "pickguard" drop constraint "pickguard_model_id_foreign";');

    this.addSql('alter table "guitar_body_texture_pivot" drop constraint "guitar_body_texture_pivot_texture_id_foreign";');

    this.addSql('alter table "guitar_model_body_pivot" drop constraint "guitar_model_body_pivot_body_id_foreign";');

    this.addSql('alter table "guitar_body_texture_pivot" drop constraint "guitar_body_texture_pivot_body_id_foreign";');
    ...
    this.addSql('drop table if exists "guitar_model_body_pivot" cascade;');

    this.addSql('drop table if exists "guitar_body_texture_pivot" cascade;');
