...
export const modelBodiesKey = Object.freeze(Object.values(Enums.GuitarBodyType));

export const bodyTexturesKey = Object.freeze(Object.values(Enums.GuitarBodyTextureType));

export const textureMediasKey = Object.freeze(Object.values(Enums.GuitarBodyTextureMediaType));

export const maxDescriptionLength = 1000; 

export const mediaFKOption = Object.freeze({deleteRule : 'set null', updateRule : 'cascade', cascade : [Cascade.ALL]});