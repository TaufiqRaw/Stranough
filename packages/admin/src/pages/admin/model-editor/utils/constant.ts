export const guitarBodyTextureMediaKey = Object.freeze(['frontHoleMask', 'mask', 'backMask', 'frontShadowTexture', 'backShadowTexture', 'frontSpecularTexture', 'backSpecularTexture', 'burstTop', 'burstBack'] as const);
