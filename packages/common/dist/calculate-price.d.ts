...
export declare const mustImplementCalculationKeys: readonly ["bridge", "bridgePickup", "guitarModel", "headstock", "knob", "middlePickup", "neckPickup", "nut", "peg", "bridge2", "pickguardMaterial"];
