export declare const burstColors: Readonly<{
    readonly "black-red": {
        readonly name: "hitam - merah (sunburst)";
        readonly value: readonly [0, 9109504];
    };
    readonly black: {
        readonly name: "hitam";
        readonly value: readonly [0];
    };
    readonly white: {
        readonly name: "putih";
        readonly value: readonly [16777215];
    };
    readonly gray: {
        readonly name: "abu-abu";
        readonly value: readonly [8421504];
    };
    readonly red: {
        readonly name: "merah";
        readonly value: readonly [16711680];
    };
    readonly orange: {
        readonly name: "orange";
        readonly value: readonly [16753920];
    };
    readonly yellow: {
        readonly name: "kuning";
        readonly value: readonly [16436245];
    };
    readonly green: {
        readonly name: "hijau";
        readonly value: readonly [6660877];
    };
    readonly blue: {
        readonly name: "biru";
        readonly value: readonly [1920728];
    };
    readonly purple: {
        readonly name: "ungu";
        readonly value: readonly [5972406];
    };
    readonly brown: {
        readonly name: "coklat";
        readonly value: readonly [9127187];
    };
    readonly turquoise: {
        readonly name: "biru langit";
        readonly value: readonly [52945];
    };
    readonly crimson: {
        readonly name: "merah tua";
        readonly value: readonly [14423100];
    };
    readonly copper: {
        readonly name: "tembaga";
        readonly value: readonly [12088115];
    };
    readonly "bright-yellow": {
        readonly name: "kuning terang";
        readonly value: readonly [16776960];
    };
    readonly emerald: {
        readonly name: "hijau zamrud";
        readonly value: readonly [5294200];
    };
    readonly "black-blue": {
        readonly name: "hitam - biru";
        readonly value: readonly [0, 1920728];
    };
    readonly "black-green": {
        readonly name: "hitam - hijau";
        readonly value: readonly [0, 6660877];
    };
    readonly "black-purple": {
        readonly name: "hitam - ungu";
        readonly value: readonly [0, 5972406];
    };
    readonly "black-brown": {
        readonly name: "hitam - coklat";
        readonly value: readonly [0, 9127187];
    };
    readonly "black crimson": {
        readonly name: "hitam - merah tua";
        readonly value: readonly [0, 14423100];
    };
    readonly "black-turquoise": {
        readonly name: "hitam - biru langit";
        readonly value: readonly [0, 52945];
    };
    readonly "black-copper": {
        readonly name: "hitam - tembaga";
        readonly value: readonly [0, 12088115];
    };
    readonly "black-yellow": {
        readonly name: "hitam - kuning";
        readonly value: readonly [0, 16776960];
    };
    readonly "blue-turquoise": {
        readonly name: "biru - biru langit";
        readonly value: readonly [1920728, 52945];
    };
}>;
export declare const solidColors: Readonly<{
    readonly RAL9010: {
...
export declare const metallicColors: Readonly<{
    readonly black: {
        readonly name: "hitam";
    };
    readonly blue: {
